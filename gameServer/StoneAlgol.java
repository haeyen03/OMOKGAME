...
public class StoneAlgol {
    ...
    // 흑돌, 백돌 위치 저장
    private List<int[]> blackStoneLocations = new ArrayList<>();
    private List<int[]> whiteStoneLocations = new ArrayList<>();
	...
	public int addStone(int[] stoneLocation, boolean isBlack) {
		...
		if (isBlack)
		{
            this.board[x][y] = 0;  // 흑돌은 0
            blackStoneLocations.add(stoneLocation);  // 흑돌 위치 저장
		}
		else 
		{
            this.board[x][y] = 1;  // 백돌은 1
            whiteStoneLocations.add(stoneLocation);  // 백돌 위치 저장
		}
    ...
    public List<int[]> getBlackStoneLocations() {
        return blackStoneLocations;
    }

    public List<int[]> getWhiteStoneLocations() {
        return whiteStoneLocations;
    }
